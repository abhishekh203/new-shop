...
const ProductDetail = () => {
    ...
    return (
        <div className="bg-gradient-to-r from-black to-blue-600"> {/* Set the background to a gradient from black to blue */}
    ...
    <button className="text-black px-5 py-2 bg-green-50 border border-green-100 rounded-lg hover:bg-green-100 hover:border-green-200 transition duration-300">
        Add Product
    </button>
</div>
