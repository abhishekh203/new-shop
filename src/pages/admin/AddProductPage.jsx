...
import { FiImage, FiDollarSign, FiTag, FiAlignLeft, FiStar, FiTrendingUp, FiPlus, FiArrowLeft, FiSave, FiXCircle, FiLoader, FiChevronDown } from "react-icons/fi";
...
const AddProductPage = () => {
    ...
    const selectedCategoryDetails = categoryList.find(cat => cat.id === product.categoryId);
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <motion.div variants={itemVariants}>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 transition duration-200 ease-in-out placeholder-gray-500 bg-gray-800/50 text-gray-100 ${
                                        formErrors.title ? 'border-red-500/50 ring-1 ring-red-500/50' : 'border-gray-600/50 focus:ring-blue-500/50 focus:border-blue-500/50'
                                    }`}
                                    required
                                />
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <motion.div variants={itemVariants}>
                                <label htmlFor="price" className="block text-sm font-medium text-gray-300 mb-1.5">
                                    Price (रु) <span className="text-red-400">*</span>
                                </label>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        min="0"
                                        step="0.01"
                                        className={`w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 transition duration-200 ease-in-out placeholder-gray-500 bg-gray-800/50 text-gray-100 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none ${
                                            formErrors.price ? 'border-red-500/50 ring-1 ring-red-500/50' : 'border-gray-600/50 focus:ring-blue-500/50 focus:border-blue-500/50'
                                        }`}
                                        required
                                    />
                                </div>
                            ...
                            <motion.div variants={itemVariants}>
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        ...
                                        className={`w-full ${selectedCategoryDetails?.icon ? 'pl-10' : 'pl-4'} pr-10 py-2.5 border rounded-lg focus:outline-none focus:ring-2 transition duration-200 ease-in-out bg-gray-800/50 text-gray-100 appearance-none cursor-pointer ${
                                            formErrors.categoryId ? 'border-red-500/50 ring-1 ring-red-500/50' : 'border-gray-600/50 focus:ring-blue-500/50 focus:border-blue-500/50'
                                        }`}
                                        required
                                    >
                            ...
                            <motion.div variants={itemVariants}>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        min="0"
                                        step="1"
                                        className="w-full pl-10 pr-4 py-2.5 border border-gray-600/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition duration-200 ease-in-out placeholder-gray-500 bg-gray-800/50 text-gray-100 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                        required
                                    />
                                </div>
                            </motion.div>
                        ...
                        <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 pt-2">
                            <div className="flex items-center">
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className="h-4 w-4 text-indigo-500 focus:ring-indigo-400 border-gray-500 rounded bg-gray-700 cursor-pointer accent-indigo-500"
                                />
                                <label htmlFor="featured" className="ml-2 block text-sm text-gray-300 cursor-pointer">
                                    <FiStar className="inline mr-1 text-yellow-400 mb-0.5" size={14}/> 
                                    Featured Product
                                </label>
                            </div>
                            <div className="flex items-center">
                                ...
                                <label htmlFor="trending" className="ml-2 block text-sm text-gray-300 cursor-pointer">
                                    <FiTrendingUp className="inline mr-1 text-green-400 mb-0.5" size={14}/> 
                                    Trending Product
                                </label>
                            </div>
                        </motion.div>
                        ...
                        {/* Image URL & Preview */}
                        <motion.div variants={itemVariants}>
                            <label htmlFor="productImageUrl" className="block text-sm font-medium text-gray-300 mb-1.5">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 transition duration-200 ease-in-out placeholder-gray-500 bg-gray-800/50 text-gray-100 ${
                                        formErrors.productImageUrl ? 'border-red-500/50 ring-1 ring-red-500/50' : 'border-gray-600/50 focus:ring-blue-500/50 focus:border-blue-500/50'
                                    }`}
                                    required
                                />
                            </div>
                            <AnimatePresence>
                                {formErrors.productImageUrl && (
                                    <motion.p 
                                        className="mt-1.5 text-xs text-red-400" 
                                        variants={errorVariants} 
                                        initial="hidden" 
                                ...
                                {imagePreview && (
                                    ...
                                    >
                                        ...
                                        <img 
                                            src={imagePreview} 
                                            alt="Preview" 
                                            className="w-32 h-32 object-cover rounded-lg border border-gray-600 bg-gray-700" 
                        ...
                        <motion.div variants={itemVariants}>
                            ...
                            <div className="relative">
                                ...
                                <textarea
                                    ...
                                    rows="5"
                                    className={`w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 transition duration-200 ease-in-out placeholder-gray-500 bg-gray-800/50 text-gray-100 ${
                                        formErrors.description ? 'border-red-500/50 ring-1 ring-red-500/50' : 'border-gray-600/50 focus:ring-blue-500/50 focus:border-blue-500/50'
                                    }`}
                                    required
                                />
                            </div>
                        ...
                        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4 pt-4">
                            ...
                            <motion.button
                                ...
                                whileHover={!isSubmitting ? { scale: 1.03, filter: 'brightness(1.1)' } : {}}
