...
import { FaTags, FaFire, FaHome, FaShoppingCart, FaTrash } from "react-icons/fa";
import {
...
const AllProduct = () => {
    ...
    }, [addToCartWithSync, notification]);
                    ...
                    >
                        ...
                        <AnimatePresence mode="wait" initial={false}>
                            {pageLoading ? (
                                ...
                                <div className="col-span-2 sm:col-span-2 lg:col-span-3 xl:col-span-4 2xl:col-span-5">
                                    <SerifEmptyState
                                        icon={FiSearch}
